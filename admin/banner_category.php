    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="row">
            <div class="col-md-7">
                <h2>Banner category Registration</h2>
            </div>
            <div class="col-md-5 text-right">
                <a href="banner_category.php" class="btn btn-success ">Go Main Page</a>
                <a href="banner_category.php?entry" class="btn btn-primary ">Data Entry</a>
            </div>
          </div>
          ...
          <?php 
                  ...
                  if (isset($_GET['deleteid'])) {
                    ...
                    $deleteq="DELETE FROM bannerCategory WHERE id=$id";
        ...
        if (isset($_POST['submit'])) {
          ...
          $query="INSERT INTO bannerCategory (category) VALUES ('$category')";
            ...
            <div class="row ">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control"  placeholder="Banner Category" name="category" required="1">
                </div>
              </div>
      ...
      <?= $msg; ?>
          <br>
        <h4>All Banner category Logo :</h4>
...
$sql = "SELECT * FROM bannerCategory ORDER BY id DESC LIMIT $start_from, $limit";  
...
<?php  
$sql = "SELECT COUNT(id) FROM bannerCategory";  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<li class='page-item'><a class='page-link' href='banner_category.php?page=".$i."'>".$i."</a></li>";  
};  
echo $pagLink . "</ul></nav>";  
?>
