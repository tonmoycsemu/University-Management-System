      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="row">
            ...
            <div class="col-md-5 text-right">
                <a href="faculty.php" class="btn btn-success ">Go Main Page</a>
                <a href="faculty.php?entry" class="btn btn-primary ">Add Data</a>
            </div>
          </div>
          ...
          <?php 
                  ...
                  if (isset($_GET['deleteid'])) {
                    $id=$_GET['deleteid'];
                    $img=$_GET['img'];
                    $deleteq="DELETE FROM faculty WHERE id=$id";
          ...
          ?>
           ...
           <?php 
                  ...
                  if (isset($_POST['update'])) { 
                      ...
                      $query="UPDATE faculty set name='$name',designation='$designation',picture='$path',details='$details',dept=$dept WHERE id=$updateid";
          ...
          <?php if (isset($_GET['edit'])) { 
                $edit=$_GET['edit'];
                $eq="SELECT * FROM faculty WHERE id=$edit";
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name" required="1" value="<?= $editrow['name'] ?>">
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                      <div class="form-group">
                          <label class="font-weight-bold">Teacher Details :</label>
                          <textarea  class="form-control" name="details" id="mywysiwyg" rows="12"><?= $editrow['details'] ?></textarea>
                      </div>
                  </div>
        ...
        if (isset($_GET['entry'])) { 
            ...
            if (isset($_POST['submit'])) {
              ...
              $query="INSERT INTO faculty (name,designation,details,picture,dept) VALUES ('$name','$designation','$details','$path',$dept)";
          ...
          <div class="form-in">
            <div class="row">
              ...
              <div class="col-md-12">
                  <div class="form-group">
                      <label class="font-weight-bold">Teacher Details :</label>
                      <textarea placeholder="Teacher Details" class="form-control" name="details" id="mywysiwyg" rows="12"></textarea>
                  </div>
              </div>
...
$sql = "SELECT * FROM faculty ORDER BY id DESC LIMIT $start_from, $limit";  
...
for ($i=1; $i<=$total_pages; $i++) {  
             $pagLink .= "<li class='page-item'><a class='page-link' href='faculty.php?page=".$i."'>".$i."</a></li>";  
};  
echo $pagLink . "</ul></nav>";  
?>
