      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="row">
            ...
            <div class="col-md-5 text-right">
                <a href="vc.php" class="btn btn-success ">Go Main Page</a>
                <a href="vc.php?entry" class="btn btn-primary ">Add Data</a>
            </div>
          </div>
          ...
          ?>
           ...
           <?php 
                  ...
                  if (isset($_POST['update'])) { 
                      ...
                      $query="UPDATE vc set name='$name',designation='$designation',picture='$path',details='$details' WHERE id=$updateid";
          ...
          <?php if (isset($_GET['edit'])) { 
                $edit=$_GET['edit'];
                $eq="SELECT * FROM vc WHERE id=$edit";
        ...
        if (isset($_GET['entry'])) { 
            ...
            if (isset($_POST['submit'])) {
              ...
              $query="INSERT INTO vc (name,designation,details,picture) VALUES ('$name','$designation','$details','$path')";
...
$sql = "SELECT * FROM vc ORDER BY id DESC LIMIT $start_from, $limit";  
